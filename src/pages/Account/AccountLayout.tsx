...
export default function AccountLayout() {
  ...
  if (!isAuthenticated) {
    // Passa a rota atual no state para que o Login possa redirecionar de volta
    // (ex: ao clicar em favoritos sem estar logado → faz login → volta para /conta/favoritos)
