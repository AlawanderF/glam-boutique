...
const router = createBrowserRouter(
  ...
  // basename lido da variável de ambiente injetada no build.
  // GitHub Pages de projeto serve em /nome-do-repo/ — o workflow abaixo define isso.
  // Em Vercel, Netlify, ou domínio próprio, fica "/" (padrão).
